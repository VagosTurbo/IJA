...
public class Room implements Environment {
        ...
        private Robot[][] robot_grid;
        private boolean[][] obstacle_grid;
        ...
        private Room(int rows, int cols) {
            ...
            this.obstacle_grid = new boolean[rows][cols];
            this.robot_grid = new Robot[rows][cols];
    ...
    public boolean addRobot(Robot robot) {
        ...
        if (!containsPosition(pos) || obstacleAt(pos) || robotAt(pos)) {
            return false;
        }
        robot_grid[pos.getRow()][pos.getCol()] = robot;
        return true;
    }
    ...
    public boolean robotAt(Position p) {
        if(containsPosition(p)){
            return robot_grid[p.getRow()][p.getCol()] != null;
        }
        return false;
    }
}
